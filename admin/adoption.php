...
if(isset($_POST['submit']))
{
    ...
    foreach ($arr as $id) 
    {
        $delete = "DELETE FROM adopction WHERE adopction_id = '$id'";
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">Adopction</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Adopction</h4>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="card m-b-30">
                                     ...
                                     <?php 
                                                ...
                                                $select_user = "SELECT * FROM adopction ORDER BY adopction_id DESC";
                                                ...
                                                while ($data_user = mysqli_fetch_array($run_user)) 
                                                {
                                                    ?>
                                                         <tr>
                                                            <td><input name="chk_id[]" class="chkbox" type="checkbox" value="<?php echo $data_user['adopction_id']; ?>"/></td>
                                                            <td><?php echo $i; ?></td>
                                                            <td><?php echo $data_user['pet_name']; ?></td>
                                                            <td><?php echo $data_user['name']; ?></td>
                                                            <td><?php echo $data_user['email']; ?></td>
                                                            <td><?php echo $data_user['ad_date']; ?></td>
                                                            <td><?php echo $data_user['phone']; ?></td>
                                                            <td><?php echo $data_user['gender']; ?></td>
                                                            <td><?php echo $data_user['age']; ?></td>
                                                            <td><?php echo $data_user['location']; ?></td>
                                                            <td><?php echo $data_user['city']; ?></td>
                                                            <td><?php echo $data_user['area']; ?></td>
